...
//        val tokens = listOf(101, 2023, 2003, 1037, 2742, 102) // Example token IDs for "[CLS] This is a test []"
...
//            outputTensor[0][3] // Assuming the first element is what you're interested in // Assuming the output is a 2D array where the first dimension corresponds to batches
//        } catch (e: Exception) {
